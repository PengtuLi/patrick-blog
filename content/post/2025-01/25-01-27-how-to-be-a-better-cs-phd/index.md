...
3. 学会总结经验：记录代码中遇到的各种问题，怎么解决的，这样下次遇到同样或类似问题就可以迅速解决。同样的问题要尽量避免犯两次。这一点我现在已经在做了，可以补充的是，对于自己写过或接触过的有价值的代码，也可以参考第二点，总结出别人的设计思路，比如对比不同大模型的能力的benchmark的流程可以总结出经验。
